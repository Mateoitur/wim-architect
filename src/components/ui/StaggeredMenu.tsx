  ...
  return (
    <div
      className={`sm-scope z-40 ${
        isFixed ? "fixed inset-5 rounded-xl overflow-hidden" : "w-full h-full"
      }`}
    >
      <div
        className={
...
.sm-scope .sm-panel-item { position: relative; color: #FFFFFFDD; font-weight: 600; font-size: 2.5rem; cursor: pointer; line-height: 1.2; letter-spacing: -1px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
